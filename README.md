# Product Case Study: Gamified Micro-Investing Feature for Paytm

This repository contains the deck for a product case study proposing a new feature integration for the Paytm app. The solution aims to help young professionals and students build better financial habits.
...
The success of this feature would be measured by:
***Adoption:** # of users opting for self-tax rules, # of pots created per user.
***Engagement:** Increase in Monthly Active Users (MAU), amount of money saved via "Fun Tax".
***Financial Impact:** Total money value in investment-linked pots, profits earned through micro-investments per user.

---
_This case study was created as a personal project to demonstrate product analysis and design skills._
